...
-- ========================================
-- NOTE: Les tables de Notifications Push (FCM) ont été déplacées vers:
-- src/main/java/com/urban/upark/data/init-notifications.sql
-- ========================================
...
create table public.disputes (
  ...
  constraint disputes_id_reservation_fkey foreign key (id_reservation) references reservation (id_reservation) on delete cascade
) TABLESPACE pg_default;

-- Index pour recherche rapide par réservation
CREATE INDEX IF NOT EXISTS idx_disputes_reservation ON disputes(id_reservation);
