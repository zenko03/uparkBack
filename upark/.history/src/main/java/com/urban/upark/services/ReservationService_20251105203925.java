...
public class ReservationService {
    ...
    // TODO: Créer ces repositories quand nécessaire
    ...
    public Reservation createReservation(ReservationRequest request) {
        ...
        // TODO: Vérifier que l'utilisateur existe (nécessite UsersRepository)
        ...
        // Créer la réservation (version simplifiée pour MVP)
        Reservation reservation = Reservation.builder()
                ...
                // .user(user) // TODO: Ajouter quand UsersRepository sera créé
                // .reservationStatus(getDefaultReservationStatus()) // TODO: Ajouter quand ReservationStatusRepository sera créé
                .build();

        Reservation savedReservation = reservationRepository.save(reservation);

        // TODO: Créer les réservations de véhicules (nécessite ReservationVehiclesRepository)
