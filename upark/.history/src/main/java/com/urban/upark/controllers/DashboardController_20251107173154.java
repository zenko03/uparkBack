    ...
    public ResponseEntity<Map<String, Object>> getApiDocumentation() {
        try {
            ...
            Map<String, Object> docs = Map.of(
                "title", "API Tableau de Bord Upark",
                "version", "1.0.0",
                "description", "Endpoints pour les statistiques du back-office selon le CDC",
                "endpoints", Map.of(
                    "overview", "GET /api/dashboard/overview - Aperçu complet du tableau de bord",
                    "health", "GET /api/dashboard/health - Vérification de disponibilité",
                    "commissions", "GET /api/dashboard/commissions - Statistiques commissions",
                    "commissionsEvolution", "GET /api/dashboard/commissions/evolution?days=30 - Évolution commissions",
                    "reservationsStatus", "GET /api/dashboard/reservations/status - Réservations par statut",
                    "reservationsEvolution", "GET /api/dashboard/reservations/evolution?days=30 - Évolution réservations",
                    "topParkingsReservations", "GET /api/dashboard/parkings/top-reservations?limit=10 - Top parkings par réservations",
                    "topParkingsRevenue", "GET /api/dashboard/parkings/top-revenue?limit=10 - Top parkings par CA",
                    "parkingOccupancy", "GET /api/dashboard/parkings/occupancy - Taux de remplissage",
                    "activeUsers", "GET /api/dashboard/users/active - Utilisateurs actifs",
                    "monthlyComparison", "GET /api/dashboard/comparison/monthly?months=6 - Comparaison mensuelle",
                    "quickStats", "GET /api/dashboard/widgets/quick-stats - Statistiques rapides"
                ),
                "cdcRequirements", Map.of(
                    "commissions", "Total des commissions générées (jour / mois / global)",
                    "reservationsStatus", "Nombre de réservations par statut",
                    "parkingRanking", "Classement des parkings les plus loués",
